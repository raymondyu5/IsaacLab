...
class BaseAlgorithm(ABC):
    ...
    def __init__(
        ...
        self.observation_space = observation_space  # type: spaces.Space
        self.action_space = action_space  # type: spaces.Space
    ...
    def load(  # noqa: C901
        ...
        **kwargs,
        ...
        if "policy_kwargs" in data:
            ...
            if saved_net_arch and isinstance(saved_net_arch,
                                             list) and isinstance(
        ...
        try:
            ...
            saved_optim_params = params["policy.optimizer"]["param_groups"][0][
                "params"]  # type: ignore[index]
            ...
            if n_params_saved == 2 * n_params:
                ...
                params["policy.optimizer"]["param_groups"][0][
                    "params"] = saved_optim_params[:
