...
parser.add_argument("--num_frames",
                    type=int,
                    default=100,
                    help="Number of environment frames to run benchmark for.")
parser.add_argument(
    "--benchmark_backend",
    type=str,
    ...
    while simulation_app.is_running():
        while num_frames < args_cli.num_frames:
            ...
            actions = (action_high - action_low) * torch.rand(
                ...
                env.unwrapped.single_action_space.shape[0],
                device=env.unwrapped.device) - action_high
