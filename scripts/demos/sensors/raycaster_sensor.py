...
parser = argparse.ArgumentParser(
    description="Example on using the raycaster sensor.")
...
class RaycasterSensorSceneCfg(InteractiveSceneCfg):
    ...
    ray_caster = RayCasterCfg(
        ...
        ray_alignment="yaw",
        pattern_cfg=patterns.LidarPatternCfg(channels=100,
...
def main():
    ...
    # design scene
    scene_cfg = RaycasterSensorSceneCfg(num_envs=args_cli.num_envs,
                                        env_spacing=2.0)
