...
parser = argparse.ArgumentParser(
    description="Example on using the different camera sensor implementations."
)
...
class SensorsSceneCfg(InteractiveSceneCfg):
    ...
    tiled_camera = TiledCameraCfg(
        ...
        offset=TiledCameraCfg.OffsetCfg(pos=(0.510, 0.0, 0.015),
                                        rot=(0.5, -0.5, 0.5, -0.5),
                                        convention="ros"),
    )
    raycast_camera = RayCasterCameraCfg(
        ...
        update_period=0.1,
        offset=RayCasterCameraCfg.OffsetCfg(pos=(0.510, 0.0, 0.015),
                                            rot=(0.5, -0.5, 0.5, -0.5),
                                            convention="ros"),
...
def run_simulator(sim: sim_utils.SimulationContext, scene: InteractiveScene):
    ...
    while simulation_app.is_running():
        ...
        if count % 10 == 0:
            ...
            rgb_images = [
                scene["camera"].data.output["rgb"][0, ..., :3],
                scene["tiled_camera"].data.output["rgb"][0]
            ]
            save_images_grid(
                rgb_images,
            ...
            depth_images = [
                ...
                scene["tiled_camera"].data.output["distance_to_image_plane"][
                    0, ..., 0],
                scene["raycast_camera"].data.output["distance_to_image_plane"]
                [0],
            ]
            save_images_grid(
                depth_images,
                ...
                filename=os.path.join(output_dir, "distance_to_camera",
                                      f"{count:04d}.jpg"),
            )
            ...
            save_images_grid(
                ...
                filename=os.path.join(output_dir, "tiled_rgb",
                                      f"{count:04d}.jpg"),
            )
            ...
            save_images_grid(
                ...
                filename=os.path.join(output_dir, "cam_rgb",
                                      f"{count:04d}.jpg"),
            )
