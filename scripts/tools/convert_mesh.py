...
parser.add_argument(
    ...
    help=
    "The method used for approximating the collision mesh. Set to 'none' to disable collision mesh generation.",
)
parser.add_argument(
    "--mass",
    type=float,
...
def main():
    ...
    cfg_class = collision_approximation_map.get(
        args_cli.collision_approximation)
