...
from scripts.workflows.tasks.stow.utils.parser_setting import save_params_to_yaml, parser
...
from scripts.workflows.tasks.stow.stow_env import StowEnv
...
def main():
    ...
    stow_env = StowEnv(env, init_pos, shelf_info=config["params"]["Shelf"])
