...
from scripts.workflows.sysID.bayes_sim.models.mdnn import MDNN  # used dynamically
from scripts.workflows.sysID.bayes_sim.models.mdrff import MDRFF  # used dynamically
from scripts.workflows.sysID.bayes_sim.utils import pdf
from scripts.workflows.sysID.bayes_sim.utils.summarizers import *  # used dynamically
...
class BayesSim(object):
    ...
    def __init__(self,
        ...
        kwargs = {
            'input_dim': (10) * (obs_dim + act_dim),
            'output_dim': params_dim,
            'output_lows': params_lows,
            'output_highs': params_highs,
    ...
    def run_training(self, params, traj_states, traj_actions):
        ...
        log_dict = self.model.run_training(x_data=traj_summaries,
                                           y_data=params,
