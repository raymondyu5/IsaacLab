...
def add_box_mesh_revolute(stage,
    ...
    door_back_mesh = UsdGeom.Mesh.Define(stage, path)
...
class AssembleArticulation:
    ...
    def init_setting(self):
        self.full_mesh_path = os.path.join(
            self.ckpt_dir, "texture_mesh/mesh-simplify-test.obj")
...
usd_file = "/home/ensu/Documents/weird/IsaacLab/source/assets/auto_articulation/asset/unknown3"
usd_name = "kitchen"
