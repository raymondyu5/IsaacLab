...
from source.isaaclab_tasks.isaaclab_tasks.manager_based.manipulation.lift import mdp
...
def main():
    ...
    if args_cli.teleop_device.lower() == "keyboard":
        teleop_interface = Se3Keyboard(pos_sensitivity=0.04,
                                       rot_sensitivity=0.08)
    elif args_cli.teleop_device.lower() == "spacemouse":
        teleop_interface = Se3SpaceMouse(pos_sensitivity=0.05,
    ...
    with contextlib.suppress(KeyboardInterrupt) and torch.inference_mode():
        while not collector_interface.is_stopped():
            ...
            collector_interface.add(
                "success",
                env.termination_manager.get_term("object_reached_goal"))
