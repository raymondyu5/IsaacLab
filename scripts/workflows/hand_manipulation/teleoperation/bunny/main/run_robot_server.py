...
def parse_args():
    ...
    parser.add_argument(
        "--kinematics-cfg",
        "-k",
        default="configs/kinematics_config/bimanual_franka_leap.yml",
        help="File path to the kinematics config.",
    )
    parser.add_argument("--camera-cfg",
                        "-c",
                        default="configs/camera_config/visionpro_config.yml",
                        help="File path to the camera config.")
    parser.add_argument(
        "--communication-cfg",
        "-comm",
        default="configs/communication_config/sim_web_visualizer_leap.yml",
