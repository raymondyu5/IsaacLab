...
from scripts.workflows.hand_manipulation.utils.cloudxr.franka_teleoperation.arm_wrapper import ArmHandWrapper
...
class Se3FrankaWrapper(ArmHandWrapper):
    ...
    def init_settings(self):
        ...
        from scripts.workflows.hand_manipulation.utils.dex_retargeting.franka_retarget import FrankaRetargeting
        ...
        retarger = LeapRetargeter(
            ...
            retarget_class=FrankaRetargeting,
            kinematics_path=
            "source/config/task/hand_env/teleoperation/bunny/kinematics_config/bimanual_panda_gripper.yml"
        )
