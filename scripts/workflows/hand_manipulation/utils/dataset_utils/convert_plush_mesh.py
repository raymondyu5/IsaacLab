...
def main():
    ...
    plush_dir = f"{current_path}/source/assets/plush"
    dest_plush_dir = f"{current_path}/plush"
    object_list = os.listdir(plush_dir)
    for name in object_list:
        dest_path = os.path.join(plush_dir, name + f"/scale_{name}.glb")
