...
# Add project root to Python path so that 'scripts' module can be imported
# Find the IsaacLab project root by looking for pyproject.toml
sys.path.append("/home/wph52/IsaacLab")

sys.path.append("/home/wph52/IsaacLab/submodule/diffusion_policy")
