...
from scripts.workflows.hand_manipulation.utils.diffusion.policy.cfm_unet_lowdim_policy import CFMnetLowdimPolicy
...
class TrainCFMUnetLowdimWorkspace(BaseWorkspace):
    ...
    def __init__(self, cfg: OmegaConf, args_cli=None):
        if args_cli is not None:
            ...
            output_dir = args_cli.log_dir + f"/cfm/state_cfm/horizon_{cfg.horizon}_nobs_{cfg.n_obs_steps}"
        ...
        cfg.policy.model.down_dims = cfg.policy.model.down_dims[:cfg.horizon //
                                                                2 + 1]
        ...
        if args_cli is not None:
            ...
            cfg.action_dim = self.dataset.action_dim

            cfg.obs_dim = self.dataset.low_obs_dim
...
if __name__ == "__main__":
    ...
    parser.add_argument("--num_demo", type=int, default=2500)
