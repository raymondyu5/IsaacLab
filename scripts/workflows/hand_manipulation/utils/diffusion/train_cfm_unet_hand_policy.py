...
class TrainCFMUnetLowdimWorkspace(BaseWorkspace):
    ...
    def __init__(self, cfg: OmegaConf, args_cli=None):
        if args_cli is not None:
            if args_cli.vae_path is not None:
                output_dir = args_cli.log_dir + f"/latent_cfm/horizon_{cfg.horizon}_nobs_{cfg.n_obs_steps}"

                cfg.policy.vae_path = args_cli.vae_path
            else:

                output_dir = args_cli.log_dir + f"/cfm/horizon_{cfg.horizon}_nobs_{cfg.n_obs_steps}"
        else:
        ...
        if args_cli is not None:
            ...
            try:
                cfg.obs_dim = self.dataset.obs_dim
