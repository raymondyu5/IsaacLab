...
class ResidualRealHandImageDataset(BaseImageDataset):
    ...
    def __init__(
        ...
        self.replay_buffer = ResidualRealImageDatasetLoader(
            data_path,
            load_list,
            obs_key,
...
if __name__ == "__main__":
    ...
    dataset = ResidualRealHandImageDataset(
        ...
        max_train_episodes=None,
        add_randomizer=True,
        crop_region=None  # [x_min, y_min, x_max, y_max]
    )
