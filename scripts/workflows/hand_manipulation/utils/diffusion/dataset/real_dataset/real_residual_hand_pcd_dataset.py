...
from scripts.workflows.hand_manipulation.utils.diffusion.dataset.real_dataset.real_residual_pcd_dataset_loader import ResidualRealPCDDatasetLoader
...
class ResidualRealHandPCDDataset(BaseImageDataset):
    ...
    def __init__(
        ...
        self.replay_buffer = ResidualRealPCDDatasetLoader(
            data_path,
            load_list,
            obs_key,
            num_demo=num_demo,
...
if __name__ == "__main__":
    ...
    dataset = ResidualRealHandPCDDataset(
