...
class TrainCFMUnetLowdimWorkspace(BaseWorkspace):
    ...
    def __init__(self, cfg: OmegaConf, args_cli=None):
        if args_cli is not None:
            ...
            output_dir = args_cli.log_dir + f"/cfm/horizon_{cfg.horizon}_nobs_{cfg.n_obs_steps}_naction_{cfg.n_action_steps}_ininference_{cfg.policy.num_inference_steps}"
        else:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--num_inference", type=int, default=2)
