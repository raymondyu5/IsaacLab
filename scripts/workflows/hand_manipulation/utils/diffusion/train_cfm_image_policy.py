    ...
    def __init__(self, cfg: OmegaConf, args_cli=None):
        ...
        if args_cli is not None:
            ...
            if cfg.policy.obs_encoder.freeze_backbone:
                ...
                output_dir = args_cli.log_dir + f"/cfm/image_cfm/horizon_{cfg.horizon}_nobs_{cfg.n_obs_steps}/freeze_{cfg.policy.obs_encoder.rgb_model.name}"
            else:
                output_dir = args_cli.log_dir + f"/cfm/image_cfm/horizon_{cfg.horizon}_nobs_{cfg.n_obs_steps}/finetune_{cfg.policy.obs_encoder.rgb_model.name}"
