...
class DexRetargeting:
    ...
    def run(self):
        ...
        qpos, ycb_object_pose, robot_ee_pose = self.mapping_env.robot_hand_pose_mapping(
        )

        self.control_function(qpos, ycb_object_pose, robot_ee_pose)
    ...
    def run_free_hand(self, qpos, ycb_object_pose, robot_ee_pose):
        ...
        for i in range(qpos.shape[0]):
            ...
            raw_root_state = self.env.scene["right_hand"]._data.root_state_w
