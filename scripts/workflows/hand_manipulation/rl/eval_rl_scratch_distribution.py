...
from scripts.workflows.hand_manipulation.env.rl_env.rl_distribution_wrapper import RLDistributionEnv
...
def main():
    ...
    while simulation_app.is_running():
        ...
        with torch.inference_mode():
            ...
            success_or_not, _ = rl_env.eval_policy_distribution(
                agent, result_path)
