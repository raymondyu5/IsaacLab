...
def main():
    ...
    agent = MultiAgentWrapper(rl_agent_env, rl_agent_env.num_agents,
                              policy_arch, args_cli, **agent_cfg)
    ...
    agent.learn(
        ...
        callback=WandbCallback(
            ...
            add_right_hand=args_cli.add_right_hand,
            add_left_hand=args_cli.add_left_hand,
            eval_cam_names=None,
