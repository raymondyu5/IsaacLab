...
from scripts.workflows.hand_manipulation.env.rl_env.rfs_env_wrapper import RFSEnvWrapper
...
def main():
    ...
    initalize_rfs_env(
        ...
        diffusion_obs_space=rl_agent_env.env.wrapper.diffusion_obs_space,
        diffusion_action_space=rl_agent_env.env.wrapper.diffusion_action_space,
    )
