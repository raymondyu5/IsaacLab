...
from scripts.workflows.open_policy.utils.sb3_wrapper import Sb3VecEnvWrapper
import imageio
import os
...
def main():
    ...
    openvla_rl_env = Sb3VecEnvWrapper(openvla_env)
    ...
    while simulation_app.is_running():
        ...
        with torch.inference_mode():
            success_or_not = openvla_env.eval_checkpoint(agent, last_obs)
