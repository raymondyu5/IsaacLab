...
from scripts.workflows.vlm_failure.stack_block.utils.failure_data_wrapper import FailureDatawrapper
...
def main():
    ...
    while not stop:
        ...
        if replay_normalized_actions:
            stop = multi_env.step_failure_env_espisode(observation,
                                                       skip_frame=2)
        else:
            stop = multi_env.step_failure_env(observation, skip_frame=1)
