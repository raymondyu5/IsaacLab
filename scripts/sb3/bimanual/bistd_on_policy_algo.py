...
from scripts.sb3.bimanual.bistd_dist import (
...
class BiStdActorCriticPolicy(BasePolicy):
    """
    ...
    def _build(self, lr_schedule: Schedule) -> None:
        ...
        if isinstance(self.action_dist, DiagGaussianDistribution):
            self.action_net, self.log_left_std, self.log_right_std = self.action_dist.proba_distribution_net(
