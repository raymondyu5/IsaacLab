...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg,
    ...
    agent_cfg: RslRlBaseRunnerCfg = cli_args.update_rsl_rl_cfg(
        agent_cfg, args_cli)
    ...
    export_policy_as_jit(policy_nn,
                         normalizer=normalizer,
                         path=export_model_dir,
                         filename="policy.pt")
    export_policy_as_onnx(policy_nn,
                          normalizer=normalizer,
                          path=export_model_dir,
