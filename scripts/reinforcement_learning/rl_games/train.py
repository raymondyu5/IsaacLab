...
parser.add_argument("--sigma",
                    type=str,
                    default=None,
                    help="The policy's initial standard deviation.")
...
parser.add_argument("--export_io_descriptors",
                    action="store_true",
                    default=False,
...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg,
    ...
    agent_cfg["params"]["config"]["max_epochs"] = (
        args_cli.max_iterations if args_cli.max_iterations is not None else
        agent_cfg["params"]["config"]["max_epochs"])
    ...
    concate_obs_groups = agent_cfg["params"]["env"].get(
    ...
    if "pbt" in agent_cfg and agent_cfg["pbt"]["enabled"]:
        observers = MultiObserver(
            [IsaacAlgoObserver(),
             PbtAlgoObserver(agent_cfg, args_cli)])
