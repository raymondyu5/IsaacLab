...
from scripts.workflows.hand_manipulation.utils.cloudxr.franka_teleoperation.teleop_env_wrapper import TeleopEnvWrapper
...
def main():
    ...
    try:
        se3_wrapper = TeleopEnvWrapper(env, save_config, args_cli)
