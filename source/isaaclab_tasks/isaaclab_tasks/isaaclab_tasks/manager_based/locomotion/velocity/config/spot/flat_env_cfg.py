...
COBBLESTONE_ROAD_CFG = terrain_gen.TerrainGeneratorCfg(
    ...
    sub_terrains={
        "flat":
        terrain_gen.MeshPlaneTerrainCfg(proportion=0.2),
        "random_rough":
...
class SpotCommandsCfg:
    ...
    base_velocity = mdp.UniformVelocityCommandCfg(
        ...
        debug_vis=True,
        ranges=mdp.UniformVelocityCommandCfg.Ranges(lin_vel_x=(-2.0, 3.0),
                                                    lin_vel_y=(-1.5, 1.5),
                                                    ang_vel_z=(-2.0, 2.0)),
    )
...
class SpotRewardsCfg:
    ...
    gait = RewardTermCfg(
        ...
        params={
            ...
            (("fl_foot", "hr_foot"), ("fr_foot", "hl_foot")),
            "asset_cfg":
    ...
    # -- penalties
    action_smoothness = RewardTermCfg(func=spot_mdp.action_smoothness_penalty,
                                      weight=-1.0)
    ...
    base_motion = RewardTermCfg(func=spot_mdp.base_motion_penalty,
                                weight=-2.0,
                                params={"asset_cfg": SceneEntityCfg("robot")})
...
class SpotTerminationsCfg:
    ...
    body_contact = DoneTerm(
        ...
        params={
            "sensor_cfg":
            SceneEntityCfg("contact_forces", body_names=["body", ".*leg"]),
            "threshold":
            1.0
        },
    )
...
class SpotFlatEnvCfg(LocomotionVelocityRoughEnvCfg):
    ...
    # Viewer
    viewer = ViewerCfg(eye=(10.5, 10.5, 0.3),
                       origin_type="world",
                       env_index=0,
                       asset_name="robot")
