...
class ObjectTableSceneCfg(InteractiveSceneCfg):
    ...
    # deform_object: Optional[DeformableObjectCfg] = field(default=None)

    # Table
    table = AssetBaseCfg(
        prim_path="{ENV_REGEX_NS}/Table",
        init_state=AssetBaseCfg.InitialStateCfg(pos=[1.0, 0, 0],
                                                rot=[0.707, 0, 0, 0.707]),
        spawn=UsdFileCfg(
            usd_path=
...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        #     func=mdp.object_node_position_in_robot_root_frame)
        object_position = ObsTerm(func=mdp.object_position_in_robot_root_frame)
        # physical_params = ObsTerm(func=mdp.object_physical_params)
        robot_qpos = ObsTerm(func=mdp.robot_qpos)
        robot_ee_pose = ObsTerm(func=mdp.robot_ee_pose)
...
class TerminationsCfg:
    ...
    # reset_deform = DoneTerm(func=mdp.reset_deform, time_out=True)
    ...
    object_dropping = DoneTerm(func=mdp.root_height_below_minimum,
                               params={
                                   "minimum_height": -0.05,
                                   "asset_cfg": SceneEntityCfg("deform_object")
                               })
