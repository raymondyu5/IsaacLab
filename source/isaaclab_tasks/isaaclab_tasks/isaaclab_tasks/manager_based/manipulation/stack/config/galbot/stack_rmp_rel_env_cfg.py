...
from isaaclab.controllers.config.rmp_flow import (  # isort: skip
    GALBOT_LEFT_ARM_RMPFLOW_CFG, GALBOT_RIGHT_ARM_RMPFLOW_CFG,
)
...
##
@configclass
class RmpFlowGalbotLeftArmCubeStackEnvCfg(
        stack_joint_pos_env_cfg.GalbotLeftArmCubeStackEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.use_relative_mode = use_relative_mode_env.lower() in [
            "true", "1", "t"
        ]
...
##
@configclass
class RmpFlowGalbotRightArmCubeStackEnvCfg(
        stack_joint_pos_env_cfg.GalbotRightArmCubeStackEnvCfg):
...
##
@configclass
class RmpFlowGalbotLeftArmCubeStackVisuomotorEnvCfg(
    ...
    def __post_init__(self):
        ...
        self.scene.right_wrist_cam = CameraCfg(
            prim_path=
            "{ENV_REGEX_NS}/Robot/right_arm_camera_sim_view_frame/right_camera",
        ...
        self.scene.left_wrist_cam = CameraCfg(
            prim_path=
            "{ENV_REGEX_NS}/Robot/left_arm_camera_sim_view_frame/left_camera",
            update_period=0.0333,
            height=256,
            width=256,
            data_types=["rgb", "distance_to_image_plane"],
        ...
        self.scene.ego_cam = CameraCfg(
            prim_path=
            "{ENV_REGEX_NS}/Robot/head_camera_sim_view_frame/head_camera",
            update_period=0.0333,
            height=256,
            width=256,
            data_types=["rgb", "distance_to_image_plane"],
        ...
        self.scene.front_cam = CameraCfg(
            ...
            spawn=sim_utils.PinholeCameraCfg(focal_length=24.0,
                                             ...
                                             horizontal_aperture=20.955,
                                             clipping_range=(0.1, 1.0e5)),
            offset=CameraCfg.OffsetCfg(pos=(1.0, 0.0, 0.6),
        ...
        self.scene.right_arm_camera_frame = FrameTransformerCfg(
            ...
            target_frames=[
                FrameTransformerCfg.FrameCfg(
                    prim_path=
                    "{ENV_REGEX_NS}/Robot/right_arm_camera_sim_view_frame",
                    name="right_camera",
                    offset=OffsetCfg(
                        pos=[0.0, 0.0, 0.0],
                        rot=(0.5, -0.5, 0.5, -0.5),
        ...
        self.scene.left_arm_camera_frame = FrameTransformerCfg(
            ...
            target_frames=[
                FrameTransformerCfg.FrameCfg(
                    prim_path=
                    "{ENV_REGEX_NS}/Robot/left_arm_camera_sim_view_frame",
                    name="left_camera",
                    offset=OffsetCfg(
                        pos=[0.0, 0.0, 0.0],
                        rot=(0.5, -0.5, 0.5, -0.5),
...
@configclass
class GalbotLeftArmJointPositionCubeStackVisuomotorEnvCfg_PLAY(
...
##
@configclass
class GalbotLeftArmRmpFlowCubeStackVisuomotorEnvCfg_PLAY(
        RmpFlowGalbotLeftArmCubeStackVisuomotorEnvCfg):
