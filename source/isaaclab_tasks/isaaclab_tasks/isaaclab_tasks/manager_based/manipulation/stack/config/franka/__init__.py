...
gym.register(
    ...
    kwargs={
        "env_cfg_entry_point":
        f"{__name__}.stack_joint_pos_env_cfg:FrankaCubeStackEnvCfg",
    },
...
gym.register(
    ...
    kwargs={
        "env_cfg_entry_point":
        f"{__name__}.stack_ik_rel_env_cfg:FrankaCubeStackEnvCfg",
        "robomimic_bc_cfg_entry_point":
        f"{agents.__name__}:robomimic/bc_rnn_low_dim.json",
    },
    disable_env_checker=True,
)
...
gym.register(
    ...
    kwargs={
        "env_cfg_entry_point":
        f"{__name__}.stack_ik_rel_visuomotor_env_cfg:FrankaCubeStackVisuomotorEnvCfg",
        "robomimic_bc_cfg_entry_point":
        f"{agents.__name__}:robomimic/bc_rnn_image_200.json",
    },
    disable_env_checker=True,
)
...
gym.register(
    ...
    kwargs={
        ...
        "robomimic_bc_cfg_entry_point":
        f"{agents.__name__}:robomimic/bc_rnn_image_cosmos.json",
    },
    disable_env_checker=True,
)
...
gym.register(
    ...
    kwargs={
        "env_cfg_entry_point":
        f"{__name__}.stack_ik_abs_env_cfg:FrankaCubeStackEnvCfg",
        "robomimic_bc_cfg_entry_point":
        f"{agents.__name__}:robomimic/bc_rnn_low_dim.json",
    },
    disable_env_checker=True,
...
gym.register(
    ...
    kwargs={
        "env_cfg_entry_point":
        f"{__name__}.stack_ik_rel_blueprint_env_cfg:FrankaCubeStackBlueprintEnvCfg",
    },
    disable_env_checker=True,
)
...
gym.register(
    ...
    kwargs={
        "env_cfg_entry_point":
        f"{__name__}.stack_ik_rel_env_cfg_skillgen:FrankaCubeStackSkillgenEnvCfg",
        "robomimic_bc_cfg_entry_point":
        f"{agents.__name__}:robomimic/bc_rnn_low_dim.json",
    },
    disable_env_checker=True,
...
gym.register(
    ...
    kwargs={
        "env_cfg_entry_point":
        f"{__name__}.bin_stack_ik_rel_env_cfg:FrankaBinStackEnvCfg",
        "robomimic_bc_cfg_entry_point":
        f"{agents.__name__}:robomimic/bc_rnn_low_dim.json",
    },
    disable_env_checker=True,
