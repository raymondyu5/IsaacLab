...
class CartpoleRGBCameraEnvCfg(DirectRLEnvCfg):
    ...
    tiled_camera: TiledCameraCfg = TiledCameraCfg(
        ...
        offset=TiledCameraCfg.OffsetCfg(pos=(-5.0, 0.0, 2.0),
                                        rot=(1.0, 0.0, 0.0, 0.0),
                                        convention="world"),
        data_types=["rgb"],
    ...
    # scene
    scene: InteractiveSceneCfg = InteractiveSceneCfg(num_envs=512,
                                                     env_spacing=20.0,
...
class CartpoleCameraEnv(DirectRLEnv):
    ...
    def __init__(self,
        ...
        self._cart_dof_idx, _ = self._cartpole.find_joints(
    ...
    def _apply_action(self) -> None:
        self._cartpole.set_joint_effort_target(self.actions,
    ...
    def _reset_idx(self, env_ids: Sequence[int] | None):
        ...
        self._cartpole.write_root_pose_to_sim(default_root_state[:, :7],
                                              env_ids)
        self._cartpole.write_root_velocity_to_sim(default_root_state[:, 7:],
                                                  env_ids)
        self._cartpole.write_joint_state_to_sim(joint_pos, joint_vel, None,
                                                env_ids)
