...
class Extraction(DisassemblyTask):
    ...
    fingertip_centered_rot_initial: list = [
        3.141593, 0.0, 0.0
    ]  # initial rotation of fingertips (Euler)
    gripper_rand_pos_noise: list = [0.05, 0.05, 0.05]
    gripper_rand_rot_noise: list = [0.174533, 0.174533,
                                    0.174533]  # +-10 deg for roll/pitch/yaw
    ...
    fixed_asset: ArticulationCfg = ArticulationCfg(
        ...
        spawn=sim_utils.UsdFileCfg(
            ...
            articulation_props=sim_utils.ArticulationRootPropertiesCfg(
                ...
                fix_root_link=
                True,  # add this so the fixed asset is set to have a fixed base
            ),
