...
class EventCfg:
    ...
    reset_gravity = EventTerm(
        ...
        mode="interval",
        is_global_time=True,
        interval_range_s=(36.0,
                          36.0),  # time_s = num_steps * (decimation * dt)
        params={
...
class ShadowHandOverEnvCfg(DirectMARLEnvCfg):
    ...
    right_robot_cfg: ArticulationCfg = SHADOW_HAND_CFG.replace(
        prim_path="/World/envs/env_.*/RightRobot").replace(
    ...
    left_robot_cfg: ArticulationCfg = SHADOW_HAND_CFG.replace(
        prim_path="/World/envs/env_.*/LeftRobot").replace(
            init_state=ArticulationCfg.InitialStateCfg(
                pos=(0.0, -1.0, 0.5),
                rot=(0.0, 0.0, 0.0, 1.0),
                joint_pos={".*": 0.0},
    ...
    object_cfg: RigidObjectCfg = RigidObjectCfg(
        ...
        spawn=sim_utils.SphereCfg(
            radius=0.0335,
            visual_material=sim_utils.PreviewSurfaceCfg(diffuse_color=(0.8,
                                                                       1.0,
                                                                       0.0)),
    ...
    # scene
    scene: InteractiveSceneCfg = InteractiveSceneCfg(num_envs=2048,
                                                     env_spacing=1.5,
