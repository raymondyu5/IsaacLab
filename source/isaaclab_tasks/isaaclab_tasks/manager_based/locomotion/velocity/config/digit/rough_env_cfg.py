...
class DigitRewards:
    ...
    feet_air_time = RewardTermCfg(
        ...
        params={
            "sensor_cfg":
            SceneEntityCfg("contact_forces", body_names=".*_leg_toe_roll"),
            "threshold":
            0.8,
            "command_name":
            "base_velocity",
    ...
    feet_slide = RewardTermCfg(
        ...
        params={
            ...
            SceneEntityCfg("contact_forces", body_names=".*_leg_toe_roll"),
            "asset_cfg":
            SceneEntityCfg("robot", body_names=".*_leg_toe_roll"),
        },
    )
    ...
    joint_deviation_feet = RewardTermCfg(
        ...
        params={
            "asset_cfg":
            SceneEntityCfg("robot", joint_names=[".*_toe_a", ".*_toe_b"])
        },
    )
...
class TerminationsCfg:
    ...
    base_contact = TerminationTermCfg(
        ...
        params={
            "sensor_cfg":
            SceneEntityCfg("contact_forces", body_names=["torso_base"]),
            "threshold":
            1.0,
        },
    )
...
class DigitRoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    ...
    def __post_init__(self):
        ...
        # Scene
        self.scene.robot = DIGIT_V4_CFG.replace(
