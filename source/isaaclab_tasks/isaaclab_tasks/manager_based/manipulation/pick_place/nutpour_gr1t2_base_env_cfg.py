...
class ObjectTableSceneCfg(InteractiveSceneCfg):
    ...
    table = AssetBaseCfg(
        ...
        spawn=UsdFileCfg(
            usd_path=
            f"{ISAACLAB_NUCLEUS_DIR}/Mimic/nut_pour_task/nut_pour_assets/table.usd",
            scale=(1.0, 1.0, 1.3),
    ...
    sorting_scale = RigidObjectCfg(
        ...
        init_state=RigidObjectCfg.InitialStateCfg(pos=[0.22236, 0.56, 0.9859],
                                                  rot=[1, 0, 0, 0]),
        spawn=UsdFileCfg(
            usd_path=
            f"{ISAACLAB_NUCLEUS_DIR}/Mimic/nut_pour_task/nut_pour_assets/sorting_scale.usd",
            scale=(1.0, 1.0, 1.0),
            rigid_props=sim_utils.RigidBodyPropertiesCfg(),
        ),
    )
    ...
    sorting_bowl = RigidObjectCfg(
        ...
        init_state=RigidObjectCfg.InitialStateCfg(
            pos=[0.02779, 0.43007, 0.9860], rot=[1, 0, 0, 0]),
        spawn=UsdFileCfg(
            usd_path=
    ...
    sorting_beaker = RigidObjectCfg(
        ...
        init_state=RigidObjectCfg.InitialStateCfg(
            pos=[-0.13739, 0.45793, 0.9861], rot=[1, 0, 0, 0]),
        spawn=UsdFileCfg(
            usd_path=
    ...
    factory_nut = RigidObjectCfg(
        ...
        init_state=RigidObjectCfg.InitialStateCfg(
            pos=[-0.13739, 0.45793, 0.9995], rot=[1, 0, 0, 0]),
        spawn=UsdFileCfg(
            usd_path=
            f"{ISAACLAB_NUCLEUS_DIR}/Mimic/nut_pour_task/nut_pour_assets/factory_m16_nut_green.usd",
            scale=(0.5, 0.5, 0.5),
            rigid_props=sim_utils.RigidBodyPropertiesCfg(),
            collision_props=sim_utils.CollisionPropertiesCfg(
                contact_offset=0.005),
    ...
    black_sorting_bin = RigidObjectCfg(
        ...
        init_state=RigidObjectCfg.InitialStateCfg(
            pos=[-0.32688, 0.46793, 0.98634], rot=[1.0, 0, 0, 0]),
        spawn=UsdFileCfg(
            usd_path=
            f"{ISAACLAB_NUCLEUS_DIR}/Mimic/nut_pour_task/nut_pour_assets/sorting_bin_blue.usd",
            scale=(0.75, 1.0, 1.0),
            rigid_props=sim_utils.RigidBodyPropertiesCfg(),
        ),
    )
    ...
    robot_pov_cam = CameraCfg(
        ...
        offset=CameraCfg.OffsetCfg(pos=(0.0, 0.12, 1.67675),
...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        left_eef_pos = ObsTerm(func=mdp.get_eef_pos,
                               params={"link_name": "left_hand_roll_link"})
        left_eef_quat = ObsTerm(func=mdp.get_eef_quat,
                                params={"link_name": "left_hand_roll_link"})
        right_eef_pos = ObsTerm(func=mdp.get_eef_pos,
                                params={"link_name": "right_hand_roll_link"})
        right_eef_quat = ObsTerm(func=mdp.get_eef_quat,
                                 params={"link_name": "right_hand_roll_link"})

        hand_joint_state = ObsTerm(func=mdp.get_robot_joint_state,
...
class TerminationsCfg:
    ...
    sorting_bowl_dropped = DoneTerm(func=mdp.root_height_below_minimum,
                                    params={
                                        "minimum_height": 0.5,
                                        "asset_cfg":
                                        SceneEntityCfg("sorting_bowl")
                                    })
    ...
    factory_nut_dropped = DoneTerm(func=mdp.root_height_below_minimum,
                                   params={
                                       "minimum_height": 0.5,
                                       "asset_cfg":
                                       SceneEntityCfg("factory_nut")
                                   })
