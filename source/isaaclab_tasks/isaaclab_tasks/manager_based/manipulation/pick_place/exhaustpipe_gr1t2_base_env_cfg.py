...
class ObjectTableSceneCfg(InteractiveSceneCfg):
    ...
    table = AssetBaseCfg(
        ...
        spawn=UsdFileCfg(
            usd_path=
            f"{ISAACLAB_NUCLEUS_DIR}/Mimic/exhaust_pipe_task/exhaust_pipe_assets/table.usd",
            scale=(1.0, 1.0, 1.3),
    ...
    blue_exhaust_pipe = RigidObjectCfg(
        ...
        init_state=RigidObjectCfg.InitialStateCfg(pos=[-0.04904, 0.31, 1.2590],
                                                  rot=[0, 0, 1.0, 0]),
        spawn=UsdFileCfg(
            usd_path=
            f"{ISAACLAB_NUCLEUS_DIR}/Mimic/exhaust_pipe_task/exhaust_pipe_assets/blue_exhaust_pipe.usd",
            scale=(0.5, 0.5, 1.5),
            rigid_props=sim_utils.RigidBodyPropertiesCfg(),
        ),
    )
    ...
    blue_sorting_bin = RigidObjectCfg(
        ...
        init_state=RigidObjectCfg.InitialStateCfg(pos=[0.16605, 0.39, 0.98634],
                                                  rot=[1.0, 0, 0, 0]),
        spawn=UsdFileCfg(
            usd_path=
            f"{ISAACLAB_NUCLEUS_DIR}/Mimic/exhaust_pipe_task/exhaust_pipe_assets/blue_sorting_bin.usd",
            scale=(1.0, 1.7, 1.0),
            rigid_props=sim_utils.RigidBodyPropertiesCfg(),
        ),
    )
    ...
    black_sorting_bin = RigidObjectCfg(
        ...
        init_state=RigidObjectCfg.InitialStateCfg(pos=[0.40132, 0.39, 0.98634],
                                                  rot=[1.0, 0, 0, 0]),
        spawn=UsdFileCfg(
            usd_path=
            f"{ISAACLAB_NUCLEUS_DIR}/Mimic/exhaust_pipe_task/exhaust_pipe_assets/black_sorting_bin.usd",
            scale=(1.0, 1.7, 1.0),
            rigid_props=sim_utils.RigidBodyPropertiesCfg(),
        ),
    )
    ...
    robot_pov_cam = CameraCfg(
        ...
        offset=CameraCfg.OffsetCfg(pos=(0.0, 0.12, 1.85418),
                                   rot=(-0.17246, 0.98502, 0.0, 0.0),
                                   convention="ros"),
    )
