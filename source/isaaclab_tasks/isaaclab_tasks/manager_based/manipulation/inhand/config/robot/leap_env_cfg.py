...
# Pre-defined configs
##
from isaaclab_assets import LEAP_UR5_ARTICULATION
...
class LeapCubeEnvCfg(inhand_env_cfg.InHandObjectEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.scene.robot = LEAP_UR5_ARTICULATION.replace(
            prim_path="{ENV_REGEX_NS}/Robot")


@configclass
class LeapCubeEnvCfg_PLAY(LeapCubeEnvCfg):
...
@configclass
class LeapCubeNoVelObsEnvCfg(LeapCubeEnvCfg):
...
@configclass
class LeapCubeNoVelObsEnvCfg_PLAY(LeapCubeNoVelObsEnvCfg):
