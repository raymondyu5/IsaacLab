...
from source.isaaclab_tasks.isaaclab_tasks.manager_based.manipulation.inhand.utils.stack.config_rigids import configure_multi_rigid_obs
# from source.isaaclab_tasks.isaaclab_tasks.manager_based.manipulation.inhand.utils.config_camera import configure_camera
from source.isaaclab_tasks.isaaclab_tasks.manager_based.manipulation.inhand.utils.stack.config_cluster_rigids import configure_multi_cluster_rigid_obs
...
from source.isaaclab_tasks.isaaclab_tasks.manager_based.manipulation.inhand.utils.stack.bimanual_franka_stack_obs import BimanualFrankaStackObs
from source.isaaclab_tasks.isaaclab_tasks.manager_based.manipulation.inhand.utils.stack.bimanual_franka_stack_rew import BimanualFrankaStackRew

from source.isaaclab_tasks.isaaclab_tasks.manager_based.manipulation.inhand.utils.config_camera import configure_camera

from source.isaaclab_tasks.isaaclab_tasks.manager_based.manipulation.inhand.utils.stack.bimanual_franka_teleoperation_obs import BimanualFrankaTeleopObs
        ...
        if env_cfg["params"].get("use_teleop", None) is not None:
            ...
            if "multi_cluster_rigid" in env_cfg["params"].keys():
                ...
                if env_cfg["params"][
                    ...
                    BimanualFrankaStackObs(env_cfg,
                                           self.observations.policy,
                                           self.scene,
                                           self.events,
                                           actions_cfg=self.actions)
                    BimanualFrankaStackRew(
                        env_cfg,
                        self.rewards,
                        self.scene,
                        self.events,
