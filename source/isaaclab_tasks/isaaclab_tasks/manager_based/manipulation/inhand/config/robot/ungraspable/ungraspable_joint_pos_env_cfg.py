...
from source.isaaclab_tasks.isaaclab_tasks.manager_based.manipulation.inhand.utils.ungraspable.config_rigids import configure_multi_rigid_obs
from source.isaaclab_tasks.isaaclab_tasks.manager_based.manipulation.inhand.utils.config_camera import configure_camera
from source.isaaclab_tasks.isaaclab_tasks.manager_based.manipulation.inhand.utils.ungraspable.config_cluster_rigids import configure_multi_cluster_rigid_obs
...
from source.isaaclab_tasks.isaaclab_tasks.manager_based.manipulation.inhand.utils.ungraspable.bimanual_franka_teleoperation_obs import BimanualFrankaTeleopObs
from isaaclab_tasks.manager_based.manipulation.inhand.utils.synthesize_pcd import configure_sysnthesize_robot_pc
from source.isaaclab_tasks.isaaclab_tasks.manager_based.manipulation.inhand.utils.ungraspable.bimanual_franka_grasp_obs import BimanualFrankaGraspObs
from source.isaaclab_tasks.isaaclab_tasks.manager_based.manipulation.inhand.utils.ungraspable.bimanual_franka_grasp_rew import BimanualFrankaGraspRew
...
class HandYCBEnvCfg(inhand_env_cfg.InHandObjectEnvCfg):
    ...
    def __post_init__(self):
        ...
        if env_cfg["params"].get("use_teleop", None) is not None:
            ...
            #         BimanualFrankaGraspObs(env_cfg, self.observations.policy,
            #                                self.scene, self.events)
            #         BimanualFrankaGraspRew(env_cfg, self.rewards, self.scene,
            #                                self.events)
