...
# Pre-defined configs
##
from isaaclab_assets import IMPLICIT_RIGHT_LEAP, IMPLICIT_LEFT_LEAP, LEAP_HAND_ACTION
...
@configclass
class LeapYCBEnvCfg(inhand_env_cfg.InHandObjectEnvCfg):
...
@configclass
class LeapYCBEnvCfg_PLAY(LeapYCBEnvCfg):
