...
gym.register(
    ...
    kwargs={
        "env_cfg_entry_point":
        f"{__name__}.joint_pos_env_cfg:FrankaCabinetEnvCfg",
...
gym.register(
    ...
    kwargs={
        "env_cfg_entry_point":
        f"{__name__}.joint_pos_env_cfg:FrankaCabinetEnvCfg_PLAY",
        "rsl_rl_cfg_entry_point":
        f"{agents.__name__}.rsl_rl_ppo_cfg:CabinetPPORunnerCfg",
        "rl_games_cfg_entry_point": f"{agents.__name__}:rl_games_ppo_cfg.yaml",
        "skrl_cfg_entry_point": f"{agents.__name__}:skrl_ppo_cfg.yaml",
...
gym.register(
    ...
    kwargs={
        "env_cfg_entry_point":
        f"{__name__}.ik_abs_env_cfg:FrankaCabinetEnvCfg",
    },
    disable_env_checker=True,
)
...
gym.register(
    ...
    kwargs={
        "env_cfg_entry_point":
        f"{__name__}.ik_rel_env_cfg:FrankaCabinetEnvCfg",
    },
    disable_env_checker=True,
)
