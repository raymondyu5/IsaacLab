...
class ObservationGalbotLeftArmGripperCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        cube_orientations = ObsTerm(func=mdp.cube_poses_in_base_frame,
                                    params={
                                        "robot_cfg": SceneEntityCfg("robot"),
                                        "return_key": "quat"
                                    })
    ...
    class RGBCameraPolicyCfg(ObsGroup):
        ...
        table_cam = ObsTerm(func=mdp.image,
                            params={
                                "sensor_cfg": SceneEntityCfg("table_cam"),
                                "data_type": "rgb",
                                "normalize": False
                            })
        wrist_cam = ObsTerm(func=mdp.image,
                            params={
...
class GalbotLeftArmCubeStackEnvCfg(StackEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.observations.policy = ObservationGalbotLeftArmGripperCfg(
        ).PolicyCfg()
        self.observations.subtask_terms = ObservationGalbotLeftArmGripperCfg(
        ).SubtaskCfg()

        # Set galbot as robot
        self.scene.robot = GALBOT_ONE_CHARLIE_CFG.replace(
...
class GalbotRightArmCubeStackEnvCfg(GalbotLeftArmCubeStackEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.scene.surface_gripper = SurfaceGripperCfg(
            prim_path=
            "{ENV_REGEX_NS}/Robot/right_suction_cup_tcp_link/SurfaceGripper",
        ...
        self.scene.ee_frame.target_frames[
            0].prim_path = "{ENV_REGEX_NS}/Robot/right_suction_cup_tcp_link"
