...
@configclass
class FrankaCubeStackVisuomotorCosmosEnvCfg(
        stack_ik_rel_visuomotor_env_cfg.FrankaCubeStackVisuomotorEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.scene.table_cam = CameraCfg(
            ...
            width=200,
            data_types=[
                "rgb", "semantic_segmentation", "normals",
