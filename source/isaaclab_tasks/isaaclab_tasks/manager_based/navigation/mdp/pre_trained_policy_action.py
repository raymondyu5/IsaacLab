...
class PreTrainedPolicyAction(ActionTerm):
    ...
    def __init__(self, cfg: PreTrainedPolicyActionCfg,
        ...
        if not check_file_path(cfg.policy_path):
            raise FileNotFoundError(
                f"Policy file '{cfg.policy_path}' does not exist.")
    ...
    def _set_debug_vis_impl(self, debug_vis: bool):
        ...
        if debug_vis:
            ...
            if not hasattr(self, "base_vel_goal_visualizer"):
                ...
                self.base_vel_goal_visualizer = VisualizationMarkers(
                    marker_cfg)
                # -- current
    ...
    def _debug_vis_callback(self, event):
        ...
        # display markers
        self.base_vel_goal_visualizer.visualize(base_pos_w, vel_des_arrow_quat,
                                                vel_des_arrow_scale)
        self.base_vel_visualizer.visualize(base_pos_w, vel_arrow_quat,
                                           vel_arrow_scale)
    ...
    def _resolve_xy_velocity_to_arrow(
        ...
        default_scale = self.base_vel_goal_visualizer.cfg.markers[
            "arrow"].scale
        # arrow-scale
