...
FRANKA_ROBOTIQ_GRIPPER_CFG.actuators = {
    ...
    ImplicitActuatorCfg(
        joint_names_expr=[
            ".*_inner_finger_knuckle_joint", "right_outer_knuckle_joint"
        ],
...
FRANKA_ARM_ACTUATOR_HIGH_PD_CFG = FRANKA_ARM_ACTUATOR_CFG.copy()
FRANKA_ARM_ACTUATOR_HIGH_PD_CFG["panda_shoulder"].stiffness = 400.0
FRANKA_ARM_ACTUATOR_HIGH_PD_CFG["panda_shoulder"].damping = 80.0
FRANKA_ARM_ACTUATOR_HIGH_PD_CFG["panda_forearm"].stiffness = 400.0
FRANKA_ARM_ACTUATOR_HIGH_PD_CFG["panda_forearm"].damping = 80.0

FRANKA_ARM_ACTION = mdp.JointPositionActionCfg(
    asset_name="robot",
    joint_names=[
