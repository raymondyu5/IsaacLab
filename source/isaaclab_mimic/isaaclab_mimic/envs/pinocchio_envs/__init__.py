...
gym.register(
    ...
    kwargs={
        "env_cfg_entry_point":
        pickplace_gr1t2_mimic_env_cfg.PickPlaceGR1T2MimicEnvCfg,
    },
...
gym.register(
    ...
    kwargs={
        "env_cfg_entry_point":
        pickplace_gr1t2_waist_enabled_mimic_env_cfg.
...
gym.register(
    ...
    kwargs={
        "env_cfg_entry_point":
        nutpour_gr1t2_mimic_env_cfg.NutPourGR1T2MimicEnvCfg
    },
    disable_env_checker=True,
)
...
gym.register(
    ...
    kwargs={
        "env_cfg_entry_point":
        exhaustpipe_gr1t2_mimic_env_cfg.ExhaustPipeGR1T2MimicEnvCfg
    },
    disable_env_checker=True,
)
...
gym.register(
    ...
    kwargs={
        "env_cfg_entry_point":
        locomanipulation_g1_mimic_env_cfg.LocomanipulationG1MimicEnvCfg
    },
    disable_env_checker=True,
)
