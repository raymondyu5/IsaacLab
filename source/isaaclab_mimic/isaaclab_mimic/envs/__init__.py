...
gym.register(
    ...
    kwargs={
        "env_cfg_entry_point":
        franka_stack_ik_rel_blueprint_mimic_env_cfg.
...
gym.register(
    ...
    kwargs={
        "env_cfg_entry_point":
        franka_stack_ik_rel_visuomotor_mimic_env_cfg.
...
gym.register(
    ...
    kwargs={
        "env_cfg_entry_point":
        (franka_stack_ik_rel_visuomotor_cosmos_mimic_env_cfg.
...
gym.register(
    ...
    kwargs={
        "env_cfg_entry_point":
        franka_stack_ik_rel_skillgen_env_cfg.
        FrankaCubeStackIKRelSkillgenEnvCfg,
    },
    disable_env_checker=True,
)
...
gym.register(
    ...
    kwargs={
        "env_cfg_entry_point":
        franka_bin_stack_ik_rel_mimic_env_cfg.FrankaBinStackIKRelMimicEnvCfg,
    },
    disable_env_checker=True,
)
...
gym.register(
    ...
    entry_point=
    f"{__name__}.galbot_stack_rmp_rel_mimic_env:RmpFlowGalbotCubeStackRelMimicEnv",
    kwargs={
        "env_cfg_entry_point":
...
gym.register(
    ...
    entry_point=
    f"{__name__}.galbot_stack_rmp_abs_mimic_env:RmpFlowGalbotCubeStackAbsMimicEnv",
    kwargs={
        "env_cfg_entry_point":
...
gym.register(
    ...
    kwargs={
        "env_cfg_entry_point":
        f"{__name__}.agibot_place_toy2box_mimic_env_cfg:RmpFlowAgibotPlaceToy2BoxMimicEnvCfg",
    },
    disable_env_checker=True,
)
