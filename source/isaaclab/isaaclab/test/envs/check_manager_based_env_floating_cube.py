...
parser = argparse.ArgumentParser(
    description=
    "This script demonstrates how to use the concept of an Environment.")
...
class MySceneCfg(InteractiveSceneCfg):
    ...
    cube: RigidObjectCfg = RigidObjectCfg(
        ...
        spawn=sim_utils.CuboidCfg(
            ...
            visual_material=sim_utils.PreviewSurfaceCfg(diffuse_color=(0.5,
                                                                       0.0,
                                                                       0.0)),
        ),
...
class CubeEnvCfg(ManagerBasedEnvCfg):
    ...
    # Scene settings
    scene: MySceneCfg = MySceneCfg(num_envs=args_cli.num_envs,
                                   env_spacing=2.5,
