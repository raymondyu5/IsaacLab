...
def env():
    ...
    return namedtuple("ManagerBasedRLEnv",
                      ["num_envs", "dt", "device", "sim"])(20, 0.1, "cpu", sim)
...
def test_str(env):
    ...
    cfg = {
        "term_1":
        RewardTermCfg(func=grilled_chicken, weight=10),
        "term_2":
        RewardTermCfg(func=grilled_chicken_with_bbq,
                      weight=5,
                      params={"bbq": True}),
        "term_3":
        RewardTermCfg(
...
def test_config_equivalence(env):
    ...
    class MyRewardManagerCfg:
        ...
        your_term = RewardTermCfg(func=grilled_chicken_with_bbq,
                                  weight=2.0,
                                  params={"bbq": True})
        his_term = RewardTermCfg(func=grilled_chicken_with_yoghurt,
                                 weight=1.0,
                                 params={
                                     "hot": False,
                                     "bland": 2.0
    ...
    class MyRewardManagerAnnotatedCfg:
        ...
        my_term: RewardTermCfg = RewardTermCfg(func=grilled_chicken,
                                               weight=10.0)
        your_term: RewardTermCfg = RewardTermCfg(func=grilled_chicken_with_bbq,
                                                 weight=2.0,
                                                 params={"bbq": True})
...
def test_compute(env):
    ...
    cfg = {
        ...
        RewardTermCfg(func=grilled_chicken, weight=10),
        "term_2":
        RewardTermCfg(func=grilled_chicken_with_curry,
                      weight=0.0,
                      params={"hot": False}),
    }
    rew_man = RewardManager(cfg, env)
...
def test_missing_weight(env):
    ...
    cfg = {
        ...
        RewardTermCfg(func=grilled_chicken, weight=10),
        "term_2":
        RewardTermCfg(func=grilled_chicken_with_bbq, params={"bbq": True}),
    }
...
def test_invalid_reward_func_module(env):
    ...
    cfg = {
        ...
        RewardTermCfg(func=grilled_chicken_with_bbq,
                      ...
                      params={"bbq": True}),
        "term_3":
        RewardTermCfg(func="a:grilled_chicken_with_no_bbq",
                      weight=0.1,
                      params={"hot": False}),
    }
...
def test_invalid_reward_config(env):
    ...
    cfg = {
        ...
        RewardTermCfg(func=grilled_chicken_with_bbq,
                      ...
                      params={"hot": False}),
        "term_2":
        RewardTermCfg(func=grilled_chicken_with_yoghurt,
                      weight=2.0,
                      params={"hot": False}),
    }
    with pytest.raises(ValueError):
