...
class ManagerBasedRLEnv(ManagerBasedEnv, gym.Env):
    ...
    def __init__(self,
        ...
        self.episode_length_buf = torch.zeros(cfg.scene.num_envs,
    ...
    def load_managers(self):
        ...
        # -- termination manager
        self.termination_manager = TerminationManager(self.cfg.terminations,
                                                      self)
    ...
    def setup_manager_visualizers(self):
        ...
        self.manager_visualizers = {
            "action_manager":
            ManagerLiveVisualizer(manager=self.action_manager),
            "observation_manager":
            ManagerLiveVisualizer(manager=self.observation_manager),
            "command_manager":
            ManagerLiveVisualizer(manager=self.command_manager),
            "termination_manager":
            ManagerLiveVisualizer(manager=self.termination_manager),
            "reward_manager":
            ManagerLiveVisualizer(manager=self.reward_manager),
            "curriculum_manager":
            ManagerLiveVisualizer(manager=self.curriculum_manager),
        }
        ...
        for group_name, group_term_names in self.observation_manager.active_terms.items(
            ...
            if has_concatenated_obs:
                ...
                for term_name, term_dim, term_cfg in zip(
                    ...
                    term_dict[term_name] = gym.spaces.Box(low=low,
                                                          high=high,
                                                          shape=term_dim)
