...
class RMPFlowAction(ActionTerm):
    ...
    def __init__(self, cfg: rmpflow_actions_cfg.RMPFlowActionCfg,
                 env: ManagerBasedEnv):
        ...
        self._rmpflow_controller = RmpFlowController(cfg=self.cfg.controller,
                                                     device=self.device)
    ...
    def process_actions(self, actions: torch.Tensor):
        ...
        self.ee_pose_des = torch.cat([self.ee_pos_des, self.ee_quat_des],
                                     dim=1)  # shape: [n, 7]
