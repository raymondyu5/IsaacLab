...
class JointPositionToLimitsActionCfg(ActionTermCfg):
    ...
    class_type: type[
        ActionTerm] = joint_actions_to_limits.JointPositionToLimitsAction
...
class EMAJointPositionToLimitsActionCfg(JointPositionToLimitsActionCfg):
    ...
    class_type: type[
        ActionTerm] = joint_actions_to_limits.EMAJointPositionToLimitsAction
...
class BinaryJointPositionActionCfg(BinaryJointActionCfg):
    ...
    class_type: type[
        ActionTerm] = binary_joint_actions.BinaryJointPositionAction
...
class BinaryJointVelocityActionCfg(BinaryJointActionCfg):
    ...
    class_type: type[
        ActionTerm] = binary_joint_actions.BinaryJointVelocityAction
...
class AbsBinaryJointPositionActionCfg(ActionTermCfg):
    ...
    class_type: type[
        ActionTerm] = binary_joint_actions.AbsBinaryJointPositionAction
...
class DifferentialInverseKinematicsActionCfg(ActionTermCfg):
    ...
    class_type: type[
        ActionTerm] = task_space_actions.DifferentialInverseKinematicsAction
...
class OperationalSpaceControllerActionCfg(ActionTermCfg):
    ...
    class_type: type[
        ActionTerm] = task_space_actions.OperationalSpaceControllerAction
...
class SurfaceGripperBinaryActionCfg(ActionTermCfg):
    ...
    class_type: type[
        ActionTerm] = surface_gripper_actions.SurfaceGripperBinaryAction
