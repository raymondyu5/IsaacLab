...
class RigidObject(AssetBase):
    ...
    def reset(self, env_ids: Sequence[int] | None = None):
        ...
        self.write_root_state_to_sim(reset_root_state, env_ids=env_ids)
    ...
    def write_root_link_pose_to_sim(self,
        ...
        root_poses_xyzw[:, 3:] = math_utils.convert_quat(root_poses_xyzw[:,
                                                         ...
                                                         to="xyzw")
        # set into simulation
        self.root_physx_view.set_transforms(root_poses_xyzw,
    ...
    def write_root_com_velocity_to_sim(self,
        ...
        # set into simulation
        self.root_physx_view.set_velocities(self._data.root_com_vel_w,
                                            indices=physx_env_ids)
    ...
    def _initialize_impl(self):
        ...
        root_prim_path_expr = self.cfg.prim_path + root_prim_path[
    ...
    def _process_cfg(self):
        ...
        self.data.reset_root_state = self._data.default_root_state.clone()
