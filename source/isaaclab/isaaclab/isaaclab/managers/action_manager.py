...
class ActionManager(ManagerBase):
    ...
    * apply actions: This operation typically sets the processed actions into the assets in the
    ...
    def __init__(self, cfg: object, env: ManagerBasedEnv):
        ...
        self._action = torch.zeros((self.num_envs, self.total_action_dim),
                                   device=self.device)
    ...
    def get_IO_descriptors(self) -> list[dict[str, Any]]:
        ...
        for term_name, term in self._terms.items():
            try:
                ...
                print(
                    f"Error getting IO descriptor for term '{term_name}': {e}")
    ...
    def get_active_iterable_terms(
        ...
        for name, term in self._terms.items():
            term_actions = self._action[env_idx,
                                        idx:idx + term.action_dim].cpu()
