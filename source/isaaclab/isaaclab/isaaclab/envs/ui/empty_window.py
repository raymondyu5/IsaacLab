...
class EmptyWindow:
    ...
    def __init__(self, env: ManagerBasedEnv, window_name: str):
        ...
        asyncio.ensure_future(
            self._dock_window(window_title=self.ui_window.title))
        ...
        with self.ui_window_elements["main_frame"]:
            # create main vstack
            self.ui_window_elements["main_vstack"] = omni.ui.VStack(spacing=5,
                                                                    height=0)
    ...
    async def _dock_window(self, window_title: str):
        ...
        if custom_window and property_window:
            custom_window.dock_in(property_window, omni.ui.DockPosition.SAME,
                                  1.0)
            custom_window.focus()
