...
class SurfaceGripperBinaryAction(ActionTerm):
    ...
    def __init__(self, cfg: actions_cfg.SurfaceGripperBinaryActionCfg,
        ...
        # parse open command
        self._open_command = torch.tensor(self.cfg.open_command,
                                          device=self.device)
        # parse close command
        self._close_command = torch.tensor(self.cfg.close_command,
                                           device=self.device)
