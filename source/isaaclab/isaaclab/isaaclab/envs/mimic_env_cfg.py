...
class SubTaskConstraintConfig:
    ...
    def generate_runtime_subtask_constraints(self):
        ...
        if self.constraint_type == SubTaskConstraintType.SEQUENTIAL:
            constrained_task_spec_key, constrained_subtask_ind = self.eef_subtask_constraint_tuple[
                1]
            assert isinstance(constrained_subtask_ind, int)
            pre_condition_task_spec_key, pre_condition_subtask_ind = self.eef_subtask_constraint_tuple[
                0]
            ...
            task_constraints_dict[(
                constrained_task_spec_key, constrained_subtask_ind)] = dict(
            ...
            task_constraints_dict[(
                ...
                pre_condition_subtask_ind)] = dict(
            ...
            constrained_task_spec_key, constrained_subtask_ind = self.eef_subtask_constraint_tuple[
                0]
            assert isinstance(constrained_subtask_ind, int)
            concurrent_task_spec_key, concurrent_subtask_ind = self.eef_subtask_constraint_tuple[
                1]
            ...
            task_constraints_dict[(
                constrained_task_spec_key, constrained_subtask_ind)] = dict(
                    ...
                    coordination_scheme_pos_noise_scale=self.
                    coordination_scheme_pos_noise_scale,
                    coordination_scheme_rot_noise_scale=self.
                    coordination_scheme_rot_noise_scale,
                    coordination_synchronize_start=self.
                    coordination_synchronize_start,
                    synchronous_steps=None,  # to be calculated at runtime
                )
            task_constraints_dict[(
                concurrent_task_spec_key, concurrent_subtask_ind)] = dict(
