...
class UnitreeG1DexRetargeting:
    ...
    def __init__(
        ...
        left_hand_urdf_path:
        str = f"{ISAACLAB_NUCLEUS_DIR}/Mimic/G1_inspire_assets/retarget_inspire_white_left_hand.urdf",
        right_hand_urdf_path:
        str = f"{ISAACLAB_NUCLEUS_DIR}/Mimic/G1_inspire_assets/retarget_inspire_white_right_hand.urdf",
    ):
