...
def spawn_mesh_sphere(
    ...
    **kwargs,
    ...
    _spawn_mesh_geom_from_mesh(prim_path, cfg, sphere, translation,
                               orientation)
    # return the prim
...
def spawn_mesh_cuboid(
    ...
    **kwargs,
    ...
    _spawn_mesh_geom_from_mesh(prim_path, cfg, box, translation, orientation,
                               None)
    # return the prim
    return prim_utils.get_prim_at_path(prim_path)
...
def spawn_mesh_cylinder(
    ...
    **kwargs,
    ...
    cylinder = trimesh.creation.cylinder(radius=cfg.radius,
                                         height=cfg.height,
                                         transform=transform)
    # spawn the cylinder as a mesh
    _spawn_mesh_geom_from_mesh(prim_path, cfg, cylinder, translation,
                               orientation)
    # return the prim
    return prim_utils.get_prim_at_path(prim_path)
...
def spawn_mesh_capsule(
    ...
    **kwargs,
    ...
    capsule = trimesh.creation.capsule(radius=cfg.radius,
                                       height=cfg.height,
                                       transform=transform)
    # spawn capsule if it doesn't exist.
    _spawn_mesh_geom_from_mesh(prim_path, cfg, capsule, translation,
                               orientation)
    # return the prim
    return prim_utils.get_prim_at_path(prim_path)
...
def spawn_mesh_cone(
    ...
    **kwargs,
    ...
    cone = trimesh.creation.cone(radius=cfg.radius,
                                 height=cfg.height,
                                 transform=transform)
...
def _spawn_mesh_geom_from_mesh(
    ...
    **kwargs,
    ...
    if cfg.deformable_props is not None and cfg.rigid_props is not None:
        raise ValueError(
            "Cannot use both deformable and rigid properties at the same time."
        )
    if cfg.deformable_props is not None and cfg.collision_props is not None:
        raise ValueError(
            "Cannot use both deformable and collision properties at the same time."
        )
    ...
    if cfg.deformable_props is not None and cfg.physics_material is not None:
        if not isinstance(cfg.physics_material, DeformableBodyMaterialCfg):
            raise ValueError(
                "Deformable properties require a deformable physics material.")
    if cfg.rigid_props is not None and cfg.physics_material is not None:
        if not isinstance(cfg.physics_material, RigidBodyMaterialCfg):
            raise ValueError(
                "Rigid properties require a rigid physics material.")
    ...
    if cfg.deformable_props is not None:
        ...
        schemas.define_deformable_body_properties(mesh_prim_path,
        ...
        schemas.define_collision_properties(mesh_prim_path,
                                            cfg.collision_props)
