...
def main():
    ...
    # Define the scene
    # -- Ball
    DynamicSphere(prim_path="/World/envs/env_0/ball",
    ...
    envs_prim_paths = cloner.generate_paths("/World/envs/env",
                                            num_paths=num_balls)
    env_positions = cloner.clone(source_prim_path="/World/envs/env_0",
    ...
    ball_initial_positions = torch.tensor(env_positions,
                                          dtype=torch.float,
                                          device=sim.device)
