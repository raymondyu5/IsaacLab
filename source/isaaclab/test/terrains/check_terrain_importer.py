...
parser = argparse.ArgumentParser(
    description="This script shows how to use the terrain importer.")
parser.add_argument("--geom_sphere",
                    action="store_true",
                    default=False,
                    help="Whether to use sphere mesh or shape.")
parser.add_argument(
    "--terrain_type",
    type=str,
...
def main():
    ...
    sim = SimulationContext(physics_dt=1.0 / 60.0,
    ...
    terrain_importer_cfg = terrain_gen.TerrainImporterCfg(
        ...
        terrain_generator=ROUGH_TERRAINS_CFG.replace(
            curriculum=True, color_scheme=args_cli.color_scheme),
