...
def export_policy_as_jit(policy: object,
...
def export_policy_as_onnx(policy: object,
                          path: str,
        ...
        if self.is_recurrent:
            ...
            if self.rnn_type == "lstm":
                ...
                raise NotImplementedError(
                    f"Unsupported RNN type: {self.rnn_type}")
...
class _OnnxPolicyExporter(torch.nn.Module):
    ...
    def export(self, path, filename):
        ...
        if self.is_recurrent:
            ...
            if self.rnn_type == "lstm":
                c_in = torch.zeros(self.rnn.num_layers, 1,
