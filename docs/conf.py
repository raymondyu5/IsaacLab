...
sys.path.insert(0,
                os.path.abspath("../source/isaaclab_assets/isaaclab_assets"))
...
exclude_patterns = [
    "_build", "_redirect", "_templates", "Thumbs.db", ".DS_Store", "README.md",
    "licenses/*"
]
...
html_theme_options = {
    ...
    "icon_links": [
        ...
        },
        {
            "name": "Stars",
            "url":
            "https://img.shields.io/github/stars/isaac-sim/IsaacLab?color=fedcba",
            "icon":
            "https://img.shields.io/github/stars/isaac-sim/IsaacLab?color=fedcba",
            "type": "url",
        },
...
smv_branch_whitelist = os.getenv("SMV_BRANCH_WHITELIST",
                                 r"^(main|devel|release/.*)$")
# Whitelist pattern for tags (set to None to ignore all tags)
smv_tag_whitelist = os.getenv("SMV_TAG_WHITELIST", r"^v[1-9]\d*\.\d+\.\d+$")
html_sidebars = {
    "**": [
        "navbar-logo.html", "versioning.html", "icon-links.html",
...
def skip_member(app, what, name, obj, skip, options):
    ...
    exclusions = [
        "from_dict", "to_dict", "replace", "copy", "validate", "__post_init__"
    ]
